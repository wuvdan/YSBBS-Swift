...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let home = HomeContainerViewController()
        let nav = HXNavigationController.init(rootViewController: home)
        ...
        KingfisherManager.shared.defaultOptions = [KingfisherOptionsInfoItem.fromMemoryCacheOrRefresh]
#if DEBUG
        let fpsLabel = V2FPSLabel(frame: CGRect(x: 15, y: kSCREEN_WIDTH-40,width: 55,height: 20));
