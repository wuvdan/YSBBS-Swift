...
class UserTopicListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let emptyView = EmptyPageView.ContentView.standard
            ...
            .set(title: "您还没有发布任何帖子~", color: UIColor.lightGray, font: UIFont.boldSystemFont(ofSize: 13))
            .mix()
  ...
  deinit {
    ...
    func loadListData(page:Int) {
        YSNetWorking().getUserTopicList(pageNo: page) { (data) -> (Void) in
...
extension UserTopicListViewController: UITableViewDataSource {
...
extension UserTopicListViewController: UITableViewDelegate {
